...
import FiltersRecent from "./FiltersRecent";
...
const FilterSection = (({
  ...
  const priceRangeId = `${priceRangeData?.min}_${priceRangeData?.max}`

  const dietaryOnChange = (key:any) => {
  ...
  console.log(showSearchinput,'showSearchinput',searchValue);
  ...
  return <>
            ...
            <div className="border border-[#434D56] rounded-md bg-[#F9F7F5] flex items-center h-12 ">
              <div className="flex relative w-full">
                <input
                  ...
                  placeholder={`${page == 'content' ? 'Search Resources' : 'Search Menu'}`}
                  value={searchValue}
                  onChange={(e) => {
                    onSearch(e)
                ...
                //   >dddddd</i>
                <MdClose className="fa fa-times absolute  top-1/2 -translate-y-1/2 text-gray-500 text-sm" size={18} color="grey" />
                )}
              </div>
    ...
    {page == 'content' ? <>
      <div className="cate_texts overflow-y-auto mb-8">
        <p onClick={() => setIsCollapsed(!isCollapsed)} className="text-black flex items-center gap-2 justify-between font-semibold text-[18px] lg:text-[16px] xl:text-[18px] cursor-pointer border-t-[1px] pt-1 mb-3 border-t-[1px] pt-1 mb-3">
    ...
    {page == 'discover' ? <>
      <div className="cate_texts overflow-y-auto mb-8">
        <p onClick={() => setGrooveCollapsed(!GrooveCollapsed)} className="text-black flex items-center gap-2 justify-between font-semibold text-[18px] lg:text-[16px] xl:text-[18px] cursor-pointer border-t-[1px] pt-1 mb-3 border-t-[1px] pt-1 mb-3">
...
<div className="cate_texts overflow-y-auto mb-8">
        <p onClick={() => tabChange('primaryUse')} className="text-black flex items-center gap-2 justify-between font-semibold text-[18px] lg:text-[16px] xl:text-[18px] cursor-pointer border-t-[1px] pt-1 mb-3 border-t-[1px] pt-1 mb-3">
      ...
      <div className="cate_texts overflow-y-auto mb-8">
        <p onClick={() => tabChange('category')} className="text-black flex items-center gap-2 justify-between font-semibold text-[18px] lg:text-[16px] xl:text-[18px] cursor-pointer border-t-[1px] pt-1 mb-3 border-t-[1px] pt-1 mb-3mb-3">
          Category {!tabs.category ? <IoIosArrowUp className="text-[#8B96A5]" /> : <IoIosArrowDown className="text-[#8B96A5]" />}
        </p>
        {tabs.category && (
          <div className="mt-4 custom-scrollbar pr-2">
            <ul>
              {theraCategories?.map((item:any) => {
                return (
    ...
    {showTags && (
      <div className="cate_texts overflow-y-auto mb-8">
        <p onClick={() => setExperiences(!Experiences)} className="text-black flex items-center gap-2 justify-between font-semibold text-[18px] lg:text-[16px] xl:text-[18px] cursor-pointer border-t-[1px] pt-1 mb-3 border-t-[1px] pt-1 mb-3">
      ...
      <div className="cate_texts overflow-y-auto mb-8">
        <p onClick={() => setDietaryCollapsed(!DietaryCollapsed)} className="text-black flex items-center gap-2 justify-between font-semibold text-[18px] lg:text-[16px] xl:text-[18px] cursor-pointer border-t-[1px] pt-1 mb-3 border-t-[1px] pt-1 mb-3">
      ...
      {/* <div className="cate_texts overflow-y-auto mb-8">
        <p onClick={() => setPriceCollapsed(!PriceCollapsed)} className="text-black flex items-center gap-2 justify-between font-semibold text-[18px] lg:text-[16px] xl:text-[18px] cursor-pointer border-t-[1px] pt-1 mb-3 border-t-[1px] pt-1 mb-3mb-3">
            ...
            <div className="">
              ...
              <div className="grid grid-cols-12 gap-3 pb-1">
                <div className="col-span-6">
                  <label>Min</label>
                  <DebouncedInput type="number" maxLength={12} value={priceRange.min} onChange={e => setPriceRange((prev:any) => ({ ...prev, min: e, max: e > prev.max ? e : prev.max }))} className="h-10 w-full border !border-[#DEE2E7] rounded-md px-3" />
                </div>
                <div className="col-span-6">
                  <label>Max</label>
                  <DebouncedInput type="number" maxLength={12} value={priceRange.max} onChange={e => setPriceRange((prev:any) => ({ ...prev, max: e, min: (e < prev.min&&e) ? e : prev.min }))} className="h-10 w-full border !border-[#DEE2E7] bg-white  rounded-md px-3" />
                </div>
    ...
    {showCategories && (
      <div className="cate_texts overflow-y-auto mb-8">
        <p onClick={() => setIsCollapsed(!isCollapsed)} className="text-black flex items-center gap-2 justify-between font-semibold text-[18px] lg:text-[16px] xl:text-[18px] cursor-pointer border-t-[1px] pt-1 mb-3 border-t-[1px] pt-1 mb-3uppercase">
