...
function Product({ product, tags, onImageClick, selectedVariant, sub_products }: Props) {
          ...
          <div className="flex flex-col gap-y-4">
            ...
            <div>
              <div className="flex justify-between">
                ...
                <div>
                  <SocialShare shareUrl={`${envirnment.frontUrl}menu/${product?.product_slug}`} />
                </div>
              </div>
                    ...
                    <TooltipHtml title={itm.description} placement="top">
                      <div className="flex gap-2 items-center">
                        <ImageHtml
                          ...
                          width={48}
                          alt={itm.name}
                          src={noImg(itm.image)} className="h-10 w-10 lg:h-12 lg:w-12 rounded-full object-cover" />
                        <p>{itm.name}</p>
                      </div>
                    </TooltipHtml>
                  </Fragment>
                ...
                return (
                  ...
                  >
                    <ImageHtml
                      ...
                      width={48}
                      alt={itm.name}
                      src={noImg(itm.images?.[0])}
                      className={`h-10 w-10 object-contain border-2 rounded-md  ${checked == itm.id ? "border-primary" : ""
                        }`}
                    />
                  </label>
                );
