...
const ProductLabel = ({ product, pProduct, onImageClick = () => {} }: any) => {
  if (!product) return <></>;
      ...
      <div className="mt-2 shadow-lg bg-white rounded-xl">
        ...
        <div className="px-4 lg:px-6 py-6">
          <div className="sm:flex gap-4  justify-between mb-2">
            <p className="text-primary font-bold lg:text-md mb-1 lg:mb-0 2xl:text-3xl text-xl">
              GROOVE
              <span className="text-black lg:text-md 2xl:text-3xl text-xl uppercase">
                {" "}
                {pProduct?.category_detail?.name}
              </span>
            </p>
            <div className="lg:text-right">
              <h5 className="uppercase text-md lg:text-lg 2xl:text-3xl">
                {pProduct?.name}
              </h5>
          ...
          <div className="border-4 border-primary py-2 rounded-xl">
            ...
            >
              <div className="flex flex-col  gap-2">
                  ...
                  {product?.flavour?.length ? (
                    <>
                      <div className="lefts_dats">
                        <p className="font-bold lg:text-lg text-md xl:text-2xl text-neutral-800 tracking-wide pl-3">
                          Flavor(s):
                        </p>
                        ...
                        <div className="flex-col gap-2 pl-3">
                          <p className="">
                            <span className="!font-regular">
                              {product?.strainData?.name || product?.strainData}
                            </span>
                          </p>
                        </div>
                      </div>
                  ...
                  <>
                    <div className="lefts_dats">
                      ...
                      <div className="flex-col gap-2 pl-3">
                        {product?.servingSize ? (
                          <>
                            <p className="font-normal text-[#626262]">
                              Serving Size{" "}
                              {product?.servingSize != "1.2 Oz" ? "1" : ""}{" "}
                              {product?.servingSize}
                            </p>
                          </>
                        ) : (
                ...
                {Number(product?.totalTheraContent || 0) ||
                Number(product?.perTheraContent || 0) ? (
                  <>
                    <div className="lefts_dats">
                      <p className="font-bold lg:text-lg text-md xl:text-2xl border-t-4 border-primary pb-2 py-1 text-neutral-800 tracking-wide pl-3">
                        Therapeutic Content
                      </p>
                      <div className="flex-col gap-2 pl-3">
                        <p className="font-normal text-[#000] italic">
                          <span className="font-semibold">
                            {Number(product?.totalTheraContent || 0) * 1000}
                          </span>
                          mg ({product?.totalTheraContent || 0}g) total per
                          container.
                        </p>
                        <p className="font-normal text-[#000] italic">
                          <span className="font-semibold">
                            {Number(product?.perTheraContent || 0) * 1000}
                          </span>
                          mg ({product?.perTheraContent || 0}g) total per
                          serving.
                        </p>
                      </div>
                    </div>
                ...
                {Number(product?.totalFuncContent || 0) ||
                Number(product?.perFuncContent || 0) ? (
                  <>
                    <div className="lefts_dats">
                      <p className="font-bold lg:text-lg text-md xl:text-2xl border-t-4 border-primary pb-2 py-1 text-neutral-800 tracking-wide pl-3">
                        Functional Content
                      ...
                      <div className="flex-col gap-2 pl-3">
                        <p className="font-normal text-[#626262] italic">
                          <span className="font-semibold">
                            {Number(product?.totalFuncContent || 0) * 1000}
                          </span>
                          mg ({product?.totalFuncContent || 0}g) total per
                          container.
                        </p>
                        <p className="font-normal text-[#626262] italic">
                          <span className="font-semibold">
                            {Number(product?.perFuncContent || 0) * 1000}
                          </span>
                          mg ({product?.perFuncContent || 0}g) total per
                          serving.
                        </p>
                      </div>
                    </div>
              ...
              <div className="flex flex-col pl-3   gap-2">
                {product?.strainData ? (
                  <>
                    <div className="lefts_dats hidden lg:block">
                      <p className="font-bold lg:text-lg text-md xl:text-2xl text-neutral-800 tracking-wide ">
                        Infused By:
                      </p>
                ...
                {product?.ingredients ? (
                  <>
                    <div className="lefts_dats hidden lg:block">
                      <p className="font-bold lg:text-lg text-xl text-neutral-800 tracking-wide">
                        Ingredients:
                      </p>
                      <p className="font-normal text-[#626262]">
                        {product?.ingredients || "--"}
                ...
                {product?.suggestedUse ? (
                  <>
                    <div className="lefts_dats">
                      <p className="font-bold lg:text-lg text-xl text-neutral-800 tracking-wide border-t-4 lg:border-0 border-primary">
                        Suggested Use:
                      </p>
                      <p className="font-normal text-[#626262]">
                        {product?.suggestedUse || "--"}
                ...
                <div className="lefts_dats mt-2">
                  <p className="font-normal  text-[#000]">
                    *These Statements have not been evaluated by the Food and
                    Drug Administration. This products is not intended to
          ...
          <div
            className="flex mt-2 items-center p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800"
            role="alert"
          >
            <svg
            ...
            <div>
              <span className="font-medium text-sm"></span> Keep Out of Reach of
              Children.
            </div>
          </div>
...
export default function ProductDetail({
  ...
  const theraTag =
    tags?.filter((itm: any) => itm.type == "Therapeutic Use") || [];
      ...
      if (res.success) {
        ...
        data.sub_products = data.sub_products
          .map((itm: any, i: any) => {
            ...
            itm.flavour = itm.flavour?.filter(
              (itm: any) => itm.status != "deactive"
            );
          ...
          .filter(
            (itm: any) => itm.status != "inacive" || itm.status != "deactive"
          );

        data.flavour = data?.flavour?.filter(
          (itm: any) => itm.status != "deactive"
        );
  ...
  const getProductReviews = (type?: any) => {
    let _type = "positive";
    if (type == "negative") {
      _type = "negative";
    }
  ...
  const handleSubmitReview = () => {
    ...
    setSubmitted(true);
    if (
      reviewForm.tags?.find((itm: any) => itm.id == "other") &&
      !reviewForm.other
    )
      return;
          ...
          if (res.success) {
            ...
            if (data) {
              setReviewForm({
                ...
                tags:
                  data.tags.map((itm: any) => ({
                    id: itm?.tag_detail?._id,
                    value: true,
                  })) || [],
  ...
  //to find the highest value in reviews
  ...
  const handleImageClick = (itm: any) => {
    ...
    setImages(
      (itm?.images?.length ? itm?.images : "") || itm.image || product?.images
    );
  };
                ...
                <Tab.Panel>
                  <div className="">
                    <div className="text-right mb-3">
                      <button
                        className="btn-primary text-sm rounded-xl lg:text-lg px-3 py-2 lg:px-5 lg:py-3"
                        onClick={() => shareExp()}
                      >
                        Share My Experience
                      </button>
                                        ...
                                        <TooltipHtml title="Total Review">
                                          <div className="bg-white flex  items-center justify-center rounded-[4px]  mb-3 ">
                                            <div className="flex flex-col gap-1 py-1  items-center  ">
                                              ...
                                              <span className="text-[#00be5f] text-[20px] font-[600] ">
                                                {" "}
                                                {item?.count}
                                              </span>
                                            </div>
                ...
                <Tab.Panel>
                  <div className="">
                    ...
                    <div className="mt-5 md:mt-8">
                      {theraTag?.length ? (
                        <>
                          <h6 className="font-semibold text-[15px] mb-4">
                            Top Experiences
                          </h6>
                              ...
                              return (
                                <>
                                  <input
                                    ...
                                    className="hidden"
                                    checked={
                                      reviewForm.tags.find(
                                        (ritm:any) => ritm.id == itm?.id
                                      )
                                        ? true
                                        : false
                                    }
                      ...
                      {fucTag?.length ? (
                        <>
                          <h6 className="font-semibold text-[15px] mb-4 mt-4">
                            Health Benefits
                          </h6>
                          <div className="imagses_co grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4">
                      ...
                      <div className="imagses_co grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 mt-4">
                        <input
                          ...
                          className="hidden"
                          checked={
                            reviewForm.tags.find((ritm:any) => ritm.id == "other")
                              ? true
                              : false
                          }
                        />
