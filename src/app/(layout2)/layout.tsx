...
import { BsCart, BsReply } from "react-icons/bs";
import { CiVideoOn } from "react-icons/ci";
import { FaRegCircleUser } from "react-icons/fa6";
import { FiBox, FiEdit, FiEdit3 } from "react-icons/fi";
...
import { MdCreditCard, MdGroupAdd, MdHistory, MdOutlineClose, MdOutlineMail } from "react-icons/md";
...
export default function Layout({
  ...
  const linkClasses = (href: string) =>
    `flex items-center gap-2 px-2 py-1 rounded-md hover:bg-gray-100 ${
    ...
    <>
      ...
      <div className="bg-white p-0 m-0">
        ...
        <main className="pageContent bg-white">
           ...
           <div className="pt-[30px] md:pt-[50px] lg:pt-[70px] xl:pt-[80px] px-4 lg:px-10 2xl:px-16">
          <div className="grid grid-cols-12 gap-4 xl:gap-6">
            <div className="col-span-12 sm:col-span-4 lg:col-span-3 relative">
              <div className="sticky top-4 ">
                <div className="hidden lg:block absolute right-4 xl:right-10 cursor-pointer top-5">
                  <TooltipHtml placement="top" title="Logout">
                    <p
                      className=" text-white bg-primary px-3 rounded-full py-1.5 text-sm"
                ...
                <div className="flex flex-col items-center border border-gray-200   w-full p-6 md:!p-10 2xl:!px-20 2xl:!pt-16 2xl:!pb-12 rounded-xl shadow ">
                  ...
                  <div className="flex items-center justify-center gap-2 flex-col mt-4">
                    <h6 className="text-2xl/7 font-semibold text-secondary break-all text-center capitalize">
                      {user?.fullName}
                    </h6>
                    ...
                    <Link href={"/profile/edit"}>
                      <button className=" text-center flex border border-gray-300 bg-[#540C0F] px-6 py-2 gap-x-2 rounded-full  items-center text-white">
                        {" "}
                        <FiEdit /> Edit Profile
                      </button>
                    </Link>
                  </div>
                  <div className="tabs_ings mt-6">
                  <div className="flex flex-col gap-y-1">
      <Link className={linkClasses("/profile")} href="/profile">
        <LuUser />
        My Profile
      </Link>
      <Link className={linkClasses("/orders")} href="/orders">
        <BsCart />
        My Orders
      </Link>
      <Link className={linkClasses("/box-profile")} href="/box-profile">
        <LuUser />
        Box Profile
      </Link>
      <Link className={linkClasses("/boxhistory")} href="/boxhistory">
        <span className="material-symbols-outlined text-[18px]">box</span>
        Box Orders History
      </Link>
      <Link className={linkClasses("/payment-history")} href="/payment-history">
        <MdHistory />
        Payment History
      </Link>
      <Link className={linkClasses("/cards")} href="/cards">
        <MdCreditCard />
        Card on File
      </Link>
      <Link className={linkClasses("/invite-a-member")} href="/invite-a-member">
        <MdGroupAdd />
        Invite a Member
      </Link>
      <Link className={linkClasses("/referrals")} href="/referrals">
        <PiUserSwitchLight />
        Referrals
      </Link>
      <span
      ...
      >
        ...
        Logout
            ...
            <div className="col-span-12 sm:col-span-8 lg:col-span-9">
              <div className="border border-gray-200 py-6 px-2 lg:p-6 rounded-xl shadow">
                {children}
              </div>
            </div>
          </div>
